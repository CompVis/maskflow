...
target_wds_dir = os.path.expanduser("./data/faceforensics_train.h5")
...
if __name__ == "__main__":
    ...
    h5_file.create_dataset(
        "video", (frame_total, 3, resolution, resolution), dtype=np.uint8
    )
    ...
    for _vframes in vg:
        ...
        h5_file["video"][start_index : start_index + len(vframes)] = vframes
