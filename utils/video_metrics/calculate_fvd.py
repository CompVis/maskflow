...
def calculate_fvd(videos1, videos2, device, method="styleganv"):
    ...
    if method == "styleganv":
        from utils.video_metrics.fvd.styleganv.fvd import (
            get_fvd_feats,
            frechet_distance,
            load_i3d_pretrained,
        )
    elif method == "videogpt":
        from utils.video_metrics.fvd.videogpt.fvd import load_i3d_pretrained
        from utils.video_metrics.fvd.videogpt.fvd import get_fvd_logits as get_fvd_feats
        from utils.video_metrics.fvd.videogpt.fvd import frechet_distance
